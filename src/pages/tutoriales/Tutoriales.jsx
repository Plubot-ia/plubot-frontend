...
const Tutoriales = () => {
  ...
  return (
    <div className="tutoriales-page about-wrapper" ref={containerRef}>
      ...
      <div className="about-container">
        ...
        >
          ...
          >
            En los orígenes del <strong className="highlight-text">Pluniverse</strong>, nació el primer Plubot legendario: <strong className="highlight-text">Byte</strong>.
          </motion.p>
          ...
          >
            Plubot no es solo una herramienta. Es una extensión de tu visión. Una inteligencia que responde a tu intuición.
          </motion.p>
          ...
          <AnimatePresence>
            {showMore && (
              ...
              >
                ...
                <motion.p className="about-text terminal-text">
                  <span className="code-line">{'>'} Analizando registros de usuario...</span>
                  A su lado, tu Plubot evoluciona. Aprende. Crece. Domina flujos y automatizaciones.
                </motion.p>
