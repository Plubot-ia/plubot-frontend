...
const TutorialesAprendizaje = () => {
  ...
  return (
    <div className="tutoriales-aprendizaje-page aprendizaje-wrapper" ref={containerRef}>
      ...
      <div className="aprendizaje-container">
        ...
        >
          ...
          >
            La <strong className="highlight-text">Academia de Automatización</strong> es el corazón del aprendizaje en el Pluniverse. Aquí, tú y tu Plubot evolucionan juntos.
          </motion.p>
          ...
          >
            Descubre cómo entrenar a tu Plubot, aprovechar recursos y convertirte en un Arquitecto del Pluniverse.
          </motion.p>
              ...
              >
                ...
                >
                  <motion.button
                    ...
                    whileTap="tap"
                    onClick={() => {
                      window.location.href = '/pluniverse/academy';
                      playActivationSound();
                    }}
                  >
                    <span className="button-glow" />
