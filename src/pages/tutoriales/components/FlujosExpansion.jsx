    ...
    {showMore && (
      ...
      >
        ...
        <motion.p className='expansion-text terminal-text'>
          ...
          Nodos son los bloques básicos de un flujo: acciones, condiciones o
          integraciones.
        </motion.p>

        <motion.p className='expansion-text terminal-text'>
          <span className='code-line'>{'>'} Construyendo flujos...</span>
          Un flujo conecta nodos para definir el comportamiento de tu Plubot,
          como saludar o procesar pagos.
        </motion.p>

        <motion.p className='expansion-text terminal-text'>
          <span className='code-line'>{'>'} Estableciendo conexiones...</span>
          Usa el sistema drag-and-drop del PluLab para conectar nodos y crear
        ...
        <motion.p className='expansion-text terminal-text'>
          ...
          En el PluLab, arrastra nodos y conéctalos para crear flujos que puedes
          probar en tiempo real.
        </motion.p>

        <motion.p className='expansion-text terminal-text'>
          <span className='code-line'>{'>'} Conectando WhatsApp...</span>
          Usa el módulo de WhatsApp para que tu Plubot chatee con clientes en
          minutos.
        </motion.p>
      </motion.div>
    )}
