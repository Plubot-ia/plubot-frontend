    ...
    <motion.div variants={variants} className='detail-item'>
      ...
      <div className='detail-content'>
        ...
        <p className='detail-text'>
          ...
          <span className='highlight'>APIs oficiales</span> y tokens encriptados
          de alta renovación.
        </p>
      </div>
    </motion.div>
  ...
  <motion.div
    ...
    style={{
      transform: isHovering
        ? transformStyleFn({ x: tilt.x, y: tilt.y })
        : staticTransformStyleFn(),
  ...
  >
    ...
    >
      <p className='mb-4'>
        ...
        <span className='highlight'>cifrado SSL/TLS</span> de última generación
        con validación de certificados reforzada.
      </p>
      <p>
