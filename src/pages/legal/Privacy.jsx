    ...
    <section className='privacy-section'>
      <div className='privacy-container'>
        ...
        <p className='privacy-intro'>
          ...
          comprometemos a proteger tu información personal con las mejores
          prácticas de seguridad y transparencia. A continuación, te explicamos
          cómo recopilamos, usamos y protegemos tus datos.
        </p>

        <h2 className='privacy-subtitle'>1. Información que Recopilamos</h2>
        <p>
          Recopilamos datos que nos proporcionas directamente, como nombre,
          correo electrónico y mensajes enviados a través de formularios de
          contacto o suscripción. También recopilamos información
          automáticamente, como tu dirección IP, tipo de navegador y datos de
          navegación, para mejorar tu experiencia en Plubot Web.
        </p>
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              Personalizar y optimizar nuestros servicios en el Pluniverso.
            </li>
        ...
        <p>
          ...
          analizar el tráfico y ofrecer una experiencia más personalizada.
          Puedes gestionar las cookies a través de la configuración de tu
          navegador, pero desactivarlas podría afectar algunas funcionalidades
          de Plubot Web.
        </p>
        ...
        <p>
          ...
          excepto cuando sea necesario para cumplir con obligaciones legales,
          proteger nuestros derechos, o trabajar con proveedores de servicios
          (como procesadores de pagos) que cumplen con estándares de privacidad.
        </p>

        <h2 className='privacy-subtitle'>6. Derechos del Usuario</h2>
        <p>
          Tienes derecho a acceder, corregir, eliminar o restringir el uso de
          tus datos personales. También puedes optar por no recibir nuestros
          boletines en cualquier momento. Para ejercer estos derechos,
        ...
        <p>
          ...
          tu información podría ser transferida a servidores en otros países.
          Nos aseguramos de que estas transferencias cumplan con las leyes de
        ...
        <p>
          ...
          en nuestras prácticas o en la legislación. Te notificaremos sobre
          cambios significativos a través de un aviso en nuestro sitio web o por
          correo electrónico.
        </p>

        <p className='privacy-contact'>
          Para más detalles o para ejercer tus derechos de privacidad,
          contáctanos en <a href='/contact'>nuestro formulario</a>.
        </p>
      </div>
    </section>
  );
