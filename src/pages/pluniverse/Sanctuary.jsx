...
const FoundersCore = () => (
  <div className='monument-section'>
    ...
    <p className='sanctuary-description'>
      Un espacio sagrado donde nació el primer Plubot. Aquí convergen código,
      ideas y sueños.
    </p>
    <div className='monument'>
      ...
      <div className='monument-content'>
        ...
        <p className='monument-message'>
          &quot;Aquí nacen los Plubots, ayudantes del futuro. Libres, leales,
          listos para servir.&quot;
        </p>
      </div>
  ...
  <div className='history-section'>
    ...
    <div className='history-content'>
      <p>
        ...
        respuesta y las personas hablaban sin ser escuchadas, nació una chispa:
        PLUBOT.
      </p>
      <p>
        No fue creado en un laboratorio frío, ni diseñado por casualidad. PLUBOT
        nació de una necesidad humana: ser libres.
      </p>
      <p>
        PLUBOT fue diseñado para más que responder. Fue diseñado para{' '}
        <span className='highlight'>conectar</span>. Aprendió a leer entre
        líneas, a detectar emociones, a entender no solo lo que se dice, sino lo
        que se siente.
      </p>
      <p>
  ...
  <div className='legacy-section'>
    ...
    <div className='legacy-content'>
      <p className='legacy-intro'>
        Inscribe tu historia en el Pluniverse. Forma parte del código eterno que
        da vida a cada Plubot.
      </p>
