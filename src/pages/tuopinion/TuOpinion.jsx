...
const OpinionHeader = React.memo(() => (
  <>
    ...
    >
      ...
      , sugerencias o sueños para hacer de Plubot una experiencia aún más épica.
      ¡Tu voz importa!
    </motion.p>
  </>
));
...
function _renderFormMessage(formMessage) {
  return (
    <AnimatePresence>
      {formMessage.text && (
        <FormMessage message={formMessage.text} status={formMessage.status} />
      )}
    </AnimatePresence>
  );
}
