...
const Contact = () => {
  ...
  const handleSubmit = useCallback(
    async (event) => {
      ...
      setFormMessage({
        text: '¡Mensaje recibido en el Pluniverse!',
        status: 'success',
      });
      ...
      // 3. Send the actual request in the background.
      const sendRequest = async () => {
        ...
        try {
          ...
          // The request was successful in the background. No UI change needed.
        } catch {
          // The background request failed.
          // We don't show an error to the user because they already got a success message.
        }
      };

      sendRequest();
    },
    [formData, connectionStrength],
  );
