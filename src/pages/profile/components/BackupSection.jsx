  ...
  return (
    <div className="profile-section backup-section">
      ...
      <div className="backup-info">
        ...
        <ul>
          <li>
            <strong>Protección contra pérdidas:</strong> Mantén tus plubots seguros incluso si hay problemas con tu cuenta o con el servidor.
          </li>
          <li>
            <strong>Transferencia entre dispositivos:</strong> Lleva tus plubots contigo a cualquier dispositivo o navegador.
          </li>
          <li>
            <strong>Compartir con otros usuarios:</strong> Exporta tus plubots para compartirlos con otros usuarios de Plubot.
          </li>
          <li>
            <strong>Versiones y experimentación:</strong> Crea respaldos antes de hacer cambios importantes para poder volver atrás si es necesario.
          </li>
        </ul>
      </div>
    </div>
