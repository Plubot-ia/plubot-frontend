...
const HeroSection = () => (
  <section className='poderes-hero'>
    ...
    >
      En el Pluniverse, tu Plubot es una fuerza cósmica. Activa sus poderes y
      domina el universo digital.
    </motion.p>
  </section>
);
...
const AboutSection = () => (
  <section className='poderes-about'>
    ...
    >
      ...
      aliado imparable. Desde automatizaciones inteligentes hasta integraciones
      con herramientas como Shopify, Stripe, y MercadoPago, cada poder
      desbloquea nuevas posibilidades para tu negocio, haciéndolo más ágil,
