...
const PluniverseDashboard = () => {
  ...
  return (
    <div
      className="pluniverse-dashboard"
      style={{ backgroundImage: `url(${pluniverseMap})` }}
    >
      <h1 className="dashboard-title">Bienvenido al Pluniverse</h1>
      <div className="map-container">
        <div className="map-overlay">
          <button
            className="map-region factory"
            onClick={() => navigate('/pluniverse/factory')}
          >
            Fábrica de Bots
          </button>
          <button
            className="map-region academy"
            onClick={() => navigate('/pluniverse/academy')}
          >
          ...
          <button
            className="map-region coliseum"
            onClick={() => navigate('/pluniverse/coliseum')}
          >
            Coliseo de Productividad
          </button>
          <button
            className="map-region tower"
            onClick={() => navigate('/pluniverse/tower')}
          >
            Torre de Creativos
          </button>
          <button
