        ...
        const staticPosts = [
          {
            ...
            excerpt:
              'Aprende a transformar tus chats en oportunidades de negocio con un chatbot.',
          },
          {
            slug: 'automatizacion-emprendedores',
            title: 'Automatización para Emprendedores: Cómo Ahorrar Tiempo',
            excerpt:
              'Consejos clave para emprendedores que buscan optimizar su rutina con IA.',
          },
          {
            slug: 'futuro-atencion-cliente',
            title: 'El Futuro de la Atención al Cliente: IA y Chatbots',
            excerpt:
              'Descubre cómo la IA redefine la atención al cliente con chatbots.',
          },
          {
  ...
  return (
    <section className='blog-posts'>
      <div className='blog-container'>
        ...
        <p>
          Descubre insights sobre tecnología, automatización y cómo impulsar tu
          negocio con IA.
        </p>
