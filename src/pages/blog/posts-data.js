export const staticPosts = {
  ...
  'automatizacion-emprendedores': {
    ...
    content: `
      ...
      <div data-percent="50" class="xp-checkpoint"></div>
      <h2>2. Optimiza el Soporte al Cliente</h2>
      <p>
        Un chatbot puede resolver dudas frecuentes 24/7, liberando a tu equipo para
        atender casos más complejos.
      </p>
      <h2>3. Automatiza el Proceso de Ventas</h2>
      <p>
        Desde la captación de leads hasta el cierre de ventas, un chatbot puede guiar a
        tus clientes en todo el proceso.
      </p>
      <h2>4. Simplifica la Gestión de Citas</h2>
      <p>
        Permite que tus clientes agenden citas o reuniones directamente desde el chat,
        evitando correos y llamadas.
      </p>
      <h2>5. Recopila Feedback de Forma Automática</h2>
      <p>
        Envía encuestas de satisfacción y recopila opiniones valiosas para mejorar tus
        productos y servicios.
      </p>
      <div data-percent="100" class="xp-checkpoint"></div>
      <h2>Conclusión</h2>
      <p>
        La automatización es tu mejor aliada para escalar. Con Plubot, puedes
        implementar estas estrategias y más. ¿Listo para empezar?
        <a href="/contacto">Contáctanos</a>.
      </p>
    `,
  },
  'chatbot-ia-negocios': {
    title: 'Chatbot con IA: 5 Razones por las que tu Negocio Necesita Uno',
    excerpt:
      'Descubre 5 razones por las que un chatbot con IA de Plubot es ' +
      'esencial para el crecimiento de tu negocio.',
    content: `
      <h2>Introducción</h2>
      <p>
        Un chatbot con inteligencia artificial no es un lujo, es una necesidad. Con
        <a href="/">Plubot</a>, puedes transformar la manera en que interactúas con tus
        clientes. Aquí te damos 5 razones para integrar uno en tu negocio.
      </p>
      <h2>1. Disponibilidad 24/7</h2>
      <p>
        Tu negocio nunca cierra. Un chatbot atiende a tus clientes a cualquier hora,
        resolviendo dudas y captando leads incluso mientras duermes.
      </p>
      <div data-percent="50" class="xp-checkpoint"></div>
      <h2>2. Reducción de Costos Operativos</h2>
      <p>
        Automatizar la atención al cliente reduce la carga de trabajo de tu equipo,
        permitiéndote optimizar recursos.
      </p>
      <h2>3. Mejora de la Experiencia del Cliente</h2>
      <p>
        Respuestas instantáneas y personalizadas aumentan la satisfacción y lealtad de
        tus clientes.
      </p>
      <h2>4. Generación de Leads de Calidad</h2>
      <p>
        Un chatbot puede calificar leads de forma automática, asegurando que tu equipo
        de ventas se enfoque en los prospectos con mayor potencial.
      </p>
      <h2>5. Escalabilidad sin Límites</h2>
      <p>
