...
const Marketplace = () => {
  ...
  useEffect(() => {
    ...
    if (window.particlesJS) {
      ...
      script.onerror = () => {
        console.error('Error al cargar particles.min.js');
      };
    }
  ...
  useEffect(() => {
    ...
    console.log('DOM Elements:', {
      title: document.querySelector('.marketplace-title'),
      subtitle: document.querySelector('.marketplace-subtitle'),
    ...
    const animateElements = () => {
      ...
      if (titleElement) {
        ...
        console.warn('Title element not found for GSAP animation');
      }
      ...
      if (subtitleElement) {
        ...
        console.warn('Subtitle element not found for GSAP animation');
      }
      ...
      if (cardElements.length > 0) {
        ...
        console.warn('Card elements not found for GSAP animation');
      }
    };
            ...
            filteredModules.map((extension, index) => (
              <div className="extension-card" key={index} onClick={() => setSelectedModule(extension)} style={{ opacity: 1 }}>
                <LazyImage
                  ...
                  onError={(e) => {
                    console.error(`Error loading image for ${extension.name}`);
        ...
        <div className="extension-modal-overlay" onClick={() => setSelectedModule(null)}>
          <div className="extension-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <LazyImage
              ...
              threshold={0.5}
              onError={(e) => {
                console.error(`Error loading modal image for ${selectedModule.name}`);
