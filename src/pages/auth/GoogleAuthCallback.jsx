        ...
        if (location.pathname === '/auth/google/callback') {
          ...
          try {
            ...
            try {
              ...
              logger.warn(
                'No se pudo decodificar el estado de Google Auth:',
                decodingError,
              );
            }
            ...
            try {
              ...
              logger.warn(
                'La autenticación con el backend falló. Usando usuario simulado. Error:',
                backendError,
              );

              // Solución de respaldo: Si falla la integración con el backend,
              // usar un usuario simulado
              ...
              const mockToken =
                ...
                'eyJzdWIiOiIxIiwibmFtZSI6IlVzdWFyaW8gZGUgR29vZ2xlIiwiaWF0IjoxNTE2MjM5MDIyfQ.' +
            ...
            if (response?.success) {
              ...
              if (response.user) {
                ...
                try {
                  ...
                  logger.warn(
                    'No se pudo guardar la copia de seguridad de los plubots:',
                    backupError,
                  );
                }
              }
