...
const HomePluniverseMap = lazy(
  () => import('../../components/home/Home-pluniverse-map'),
);
const HomeForge = lazy(() => import('../../components/home/Home-forge'));
const HomeArsenal = lazy(() => import('../../components/home/Home-arsenal'));
const HomeChronicles = lazy(
  () => import('../../components/home/Home-chronicles'),
);
const HomeUniverse = lazy(() => import('../../components/home/Home-universe'));
const HomeCosmicCall = lazy(
  () => import('../../components/home/Home-cosmic-call'),
);
import './Home.css';
...
const Home = () => {
  ...
  return (
    <div className='pluniverse-container'>
      ...
      <Suspense
        fallback={
          <div className='loading-placeholder'>Cargando el Pluniverse...</div>
        }
      >
        <HomePluniverseMap />
        <HomeForge />
