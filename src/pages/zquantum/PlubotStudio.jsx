...
const initialNodes = [
  {
    id: '1',
    type: 'input',
    data: { label: 'Inicio de conversación' },
    position: { x: 250, y: 5 },
  },
  {
    id: '2',
    data: { label: 'Enviar mensaje: Hola, ¿en qué puedo ayudarte hoy?' },
    position: { x: 250, y: 100 },
  },
  {
    id: '3',
    data: { label: 'Rama de decisión' },
  ...
  {
    id: '6',
    data: { label: 'Enviar a WhatsApp' },
    position: { x: 250, y: 400 },
  },
  {
    id: '7',
    type: 'output',
    data: { label: 'Finalizar flujo' },
