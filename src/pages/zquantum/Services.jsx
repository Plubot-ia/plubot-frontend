...
const Services = () => {
  ...
  useEffect(() => {
    const servicesDetails = servicesDetailsRef.current;
    ...
    <>
      <section className="services-hero">
        <div className="services-hero-content">
          ...
          <p className="services-subtitle">Soluciones de IA para transformar tu negocio</p>
        </div>
      </section>

      <section className="services-details" ref={servicesDetailsRef}>
      ...
      <section className="services-cta">
        <div className="services-container">
          ...
          <p>Contáctanos y descubre cómo nuestros chatbots pueden transformar tu operación.</p>
