...
function _addNodeHelper(params, get) {
...
function _deleteNodeHelper(nodeIdToDelete, get) {
...
export const createNodeSlice = (set, get) => ({
  ...
  addNode: (nodeData, position, userData) => {
    return _addNodeHelper({ nodeData, position, userData }, get);
  },
  ...
  deleteNode: (nodeIdToDelete) => {
    _deleteNodeHelper(nodeIdToDelete, get);
  },
