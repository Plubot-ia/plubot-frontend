...
const useAuthStore = create(
  persist(
    (set, get) => {
      // Escuchar el evento de logout para desacoplar de axiosConfig
      ...
      return {
        ...
        checkAuth: async () => {
          ...
          try {
            if (_profileCache.isValid()) {
              set({
                user: _profileCache.data,
                isAuthenticated: true,
                loading: false,
                error: null,
              });
          ...
          // Verificar si hay token en localStorage o sessionStorage
            ...
            while (retryCount < maxRetries) {
              try {
                ...
                // eslint-disable-next-line no-await-in-loop
                await sleep(1000 * retryCount); // Espera progresiva
              }
            }
            ...
            // Asegurarse de que el usuario tenga un array de plubots válido
              ...
              set({
                ...
                _isLoadingProfile: false, // Atomic update
              });
