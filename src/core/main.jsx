...
// Importar optimizador de consola para reducir mensajes repetitivos
import { optimizeConsole } from '../components/onboarding/flow-editor/utils/console-optimizer';

// Inicializar optimizador de consola SIEMPRE para reducir mensajes excesivos
// Solo se puede desactivar explícitamente
if (localStorage.getItem('disableConsoleOptimizer') !== 'true') {
  optimizeConsole();
  console.log('[Console Optimizer] Activado - Se han suprimido mensajes repetitivos');
}
