...
const ExportCard = ({ onExport, isLoading, user }) => (
  <div className='action-card export-card'>
    ...
    <p>
      Descarga todos tus plubots como archivo JSON para guardarlos de forma
      segura.
    </p>
    <button
...
const BackupTips = () => (
  <div className='backup-tips'>
    ...
    <ul>
      ...
      <li>
        Guarda los archivos de respaldo en múltiples ubicaciones (nube, disco
        externo, etc.).
      </li>
      <li>
      ...
      <li>
        Al importar plubots existentes, puedes elegir sobrescribir o mantener
        ambas versiones.
      </li>
    </ul>
  </div>
