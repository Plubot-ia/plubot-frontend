...
function initIfInEditor() {
  ...
  if (isInEditor) {
    ...
    console.log('[initPerformanceMonitor] Monitor inicializado en el editor de flujos');
  } else {
    console.log('[initPerformanceMonitor] No estamos en el editor, no se inicializa el monitor');
  }
  
  console.log('[initPerformanceMonitor] Monitor de rendimiento configurado para inicializarse');
