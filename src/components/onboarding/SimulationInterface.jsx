...
const SimulationInterface = ({
  ...
  // Actualizar historial según el flujo
  useEffect(() => {
    if (startNodeId) {
      const newMessages = traverseFlow(nodes, edges, startNodeId, userResponses, userMessages);
      setSimulationHistory(newMessages);
    }
  }, [nodes, edges, startNodeId, userResponses, userMessages]);
