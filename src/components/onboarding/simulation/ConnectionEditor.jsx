...
function _extractConnectionStyle(selectedConnection, defaultStyle) {
  return {
    ...
    strokeWidth:
      selectedConnection?.style?.strokeWidth || defaultStyle.strokeWidth,
    strokeDasharray:
      selectedConnection?.style?.strokeDasharray ||
      defaultStyle.strokeDasharray,
  };
}
...
const useConnectionEditorLogic = ({
  ...
  useEffect(() => {
    return _setupKeyboardShortcuts(
      setShowConnectionEditor,
      saveConnectionChanges,
      hasChanges,
    );
    ...
    <div className='ts-editor-section'>
      <div className='ts-form-group'>
        ...
        <div className='ts-input-with-suggestion'>
          <input
            ...
            onChange={(event) =>
              handlePropertyChange('label', event.target.value)
            }
      ...
      <div className='ts-form-group'>
        ...
        <input
          ...
          onChange={(event) =>
            handleStyleChange('strokeWidth', Number(event.target.value))
          }
        />
        ...
        <label>
          <input
            ...
            onChange={(event) =>
              handleStyleChange(
                'strokeDasharray',
                event.target.checked ? '5 5' : undefined,
              )
            }
          />{' '}
      ...
      <div className='ts-form-group'>
        <label>
          <input
            ...
            onChange={(event) =>
              handlePropertyChange('animated', event.target.checked)
            }
          />{' '}
          Animación de flujo{' '}
