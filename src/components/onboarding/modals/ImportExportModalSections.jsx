...
export const ImportSection = ({
  ...
  <div className='ts-import-section'>
    <div className='ts-import-options'>
      ...
      <p>
        Puedes pegar el contenido del flujo directamente o seleccionar un
        archivo:
      </p>
    ...
    <div className='ts-warning-message'>
      ...
      <p>
        La importación reemplazará tu flujo actual. Asegúrate de hacer una copia
        de seguridad si no quieres perder tu trabajo actual.
      </p>
    </div>
    <div className='ts-import-actions'>
      ...
      {confirmationNeeded ? (
        <div className='ts-confirmation-buttons'>
          ...
          <button
            onClick={() => setConfirmationNeeded(undefined)}
