...
import { FaWhatsapp, FaCheckCircle, FaRocket, FaShieldAlt, FaChartLine, FaTimes, FaClock } from 'react-icons/fa';
      ...
      >
        ...
        {step === 1 && (
          <div className="migration-modal-body">
            ...
            <div className="demo-warning" style={{ 
              ...
              <div>
                ...
                <p style={{ margin: '4px 0 0 0', fontSize: '14px', color: 'rgba(255, 255, 255, 0.8)' }}>El QR es solo para pruebas (máx. 20 usuarios). Para producción real, necesitas la API oficial.</p>
              </div>
            </div>
            ...
            <div className="pricing-info">
              ...
              <div className="migration-setup-list">
                ...
                <div className="migration-setup-item">✓ Sin necesidad de conocimientos técnicos</div>
          ...
          <div className="step-content">
            ...
            <form className="migration-form">
              ...
              <div className="info-box">
                ...
                <p>Gestionamos todo con Meta. Recibirás un email con los siguientes pasos en 24 horas.</p>
              </div>
