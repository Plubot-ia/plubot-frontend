  ...
  useEffect(() => {
    const generateResources = async () => {
      ...
      const generateFallbackResources = () => {
        ...
        // Extraer template literal anidado para evitar sonarjs/no-nested-template-literals
                  ...
                  <div className='embed-customize-form'>
                    <div className='embed-form-group'>
                      ...
                      <select
                        ...
                        onChange={(event) =>
                          handleCustomizationChange('theme', event.target.value)
                        }
                      >
                    ...
                    <div className='embed-form-group'>
                      ...
                      <input
                        ...
                        onChange={(event) =>
                          handleCustomizationChange('width', event.target.value)
                        }
                      />
                    </div>
                    <div className='embed-form-group'>
                    ...
                    <div className='embed-form-group'>
                      <label htmlFor='embed-primary-color'>
                        Color Primario:
                      </label>
                      <input
                    ...
                    <div className='embed-form-group'>
                      <label htmlFor='embed-welcome-message'>
