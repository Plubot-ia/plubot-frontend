...
export const getConnectorColor = (conditionText, index = 0) => {
  ...
  // eslint-disable-next-line security/detect-object-injection -- type controlled by function parameter (TRUE/FALSE)
...
export const generateNodeId = (prefix = 'decision') => {
  ...
  return `${prefix}_${Date.now()}_${(Date.now() % 1_000_000).toString(36)}`;
};
