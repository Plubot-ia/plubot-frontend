...
const DecisionNode = ({ 
  ...
  const nodeData = useFlowStore(state => {
    ...
    const dataFromStore = node?.data || {};

    // Fusionamos los datos asegurando que `question` tenga siempre un valor.
    // Si `dataFromStore.question` es undefined, null, o '', se usará el valor por defecto.
    return { 
      ...defaultData, 
      ...dataFromStore,
      question: dataFromStore.question || dataFromStore.label || defaultData.question
    };
  });
