...
Este directorio contiene todos los nodos utilizados en el editor de flujos de Plubot. La estructura está organizada de la siguiente manera:

## Organización

Cada tipo de nodo tiene su propia subcarpeta que contiene todos los archivos relacionados con ese nodo:
...
Todos los nodos implementan un modo de "Ultra Rendimiento" que optimiza la visualización y el rendimiento para trabajar con cientos de nodos sin problemas. Este modo:
