          ...
          <div className='ai-node-content'>
            ...
            {isSettingsExpanded && (
              <div className='ainode-section'>
                ...
                <div
                  className='ainode-parameter-item'
            ...
            {isLoading && (
              <div className='ainode-status-indicator ainode-status-loading'>
                Procesando IA...
              </div>
            )}
            {error && (
              <div className='ainode-status-indicator ainode-status-error'>
                {error}
              </div>
            )}
...
const arePropertiesEqual = (
  ...
  const dataChanged =
    Object.keys(previousProperties.data).length !==
      Object.keys(nextProperties.data).length ||
  ...
  return (
    previousProperties.selected === nextProperties.selected && !dataChanged
  );
};
