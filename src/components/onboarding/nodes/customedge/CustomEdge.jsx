...
const CustomEdge = (props) => {
  ...
  if (typeof sourceHandle === 'string' && sourceHandle.startsWith('|||{')) {
    try {
      ...
      console.log('CustomEdge: Procesando sourceHandle con formato JSON:', handleData);
      ...
      console.error('CustomEdge: Error al procesar sourceHandle con formato JSON:', error);
