...
const useModalManagement = () => {
  ...
  const setShowEmbedModal = useCallback(
    (value) =>
      setModalStates((previous) => ({ ...previous, showEmbedModal: value })),
    [],
  );
  ...
  const setShowSimulation = useCallback(
    (value) =>
      setModalStates((previous) => ({ ...previous, showSimulation: value })),
    [],
  );
  const setShowSyncModal = useCallback(
    (value) =>
      setModalStates((previous) => ({ ...previous, showSyncModal: value })),
    [],
  );
  ...
  const modalOpeners = useCallback(
    () => createModalOpeners(setters),
    [setters],
  );
  const modalClosers = useCallback(
    () => createModalClosers(setters),
    [setters],
  );
  ...
  useEffect(() => {
    return setupModalEventListeners(
      openModalByNameHandler,
      closeModalByNameHandler,
    );
