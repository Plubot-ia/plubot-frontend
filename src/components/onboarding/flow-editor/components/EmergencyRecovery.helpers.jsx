...
export const renderCloseButton = (handleClose) => (
  <button
    onClick={handleClose}
    style={emergencyRecoveryStyles.closeButton}
    aria-label='Cerrar'
  >
    &times;
  </button>
...
export const renderModalContent = (handleRecovery) => (
  <>
    <div style={emergencyRecoveryStyles.title}>
      ⚠️ ¡Alerta de Fusión de Quanta! ⚠️
    </div>
    <div>
      Se detectó una anomalía en la matriz de nodos. ¿Restaurar desde la última
