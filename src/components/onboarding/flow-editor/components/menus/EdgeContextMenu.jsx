...
const EdgeContextMenu = ({ position, onClose }) => {
  const selectedEdge = useFlowStore(state => state.edges.find(e => e.id === state.selectedEdge));
  ...
  return (
    <div className="edge-context-menu" style={menuStyle}>
      ...
      >
        ...
        {selectedEdge.animated ? 'Desactivar Animaciu00f3n' : 'Activar Animaciu00f3n'}
      </div>
      ...
      <div className="menu-separator" style={{ height: '1px', backgroundColor: '#eee', margin: '5px 0' }} />
