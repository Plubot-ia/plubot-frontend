...
import ShareModal from '@/components/onboarding/modals/ShareModal';
...
/**
 * Renderiza el ShareModal cuando está activo
 *
 ...
 * @returns {JSX.Element|null} ShareModal o null
 */
  ...
  return (
    <div style={{ pointerEvents: 'auto' }}>
      <ShareModal
        ...
        plubotId={flowId}
        plubotName={plubotInfo?.name || 'Mi Plubot'}
      />
    </div>
  );
};
