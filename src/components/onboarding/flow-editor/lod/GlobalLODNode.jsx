 ...
 */
const GlobalLODNode = memo(({ data, FullNode, CompactNode, MiniNode, ...props }) => {
  ...
  switch (lodLevel) {
    case LOD_LEVELS.COMPACT:
      return <CompactNode data={data} {...props} />;
    case LOD_LEVELS.MINI:
      return <MiniNode data={data} {...props} />;
    case LOD_LEVELS.FULL:
    default:
      return <FullNode data={data} {...props} />;
  }
});
